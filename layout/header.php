...
<html lang="en">
  ...
  <body>
    ...
    <!-- Fixed navbar -->
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue" style="background-color: orange">
      <div class="container">
    ...
    <a href="" class="logo" style="text-decoration: none; font-size: 14pt; font-family: verdana;">
        <img src="<?php echo $url.'assets/img/LOGO.png'; ?>" height="50" />
        ...
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="menu.php">Daftar Kue </a></li> 
            <li><a href="kontak.php">Kontak dan Profil</a></li> 
