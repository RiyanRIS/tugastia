...
<div class="col-md-9">
	...
	if (!empty($_POST['form-order'])) {
		...
		if ($difference->days >= 1) {
			...
			$q = mysql_query("insert into pesanan Values(NULL,'$tanggal_pesan','$tanggal_digunakan','$_SESSION[iam_user]','$nama','$nama_penerima','$alamat','$kt->nama','$kt->ongkir','$telephone','0','belum lunas')");
			if ($q) {
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class='input-group date' id='datetimepicker'>
						<input type='text' class="form-control" name="tanggal_digunakan" value="<?php echo (!empty($_POST['tanggal_digunakan'])) ? $_POST['tanggal_digunakan'] : ''; ?>" required />
				...
				<input type="text" class="form-control" name="nama_penerima" placeholder="Nama Penerima" required value="<?php echo (!empty($_POST['nama_penerima'])) ? $_POST['nama_penerima'] : ''; ?>"><br>
